...
"<form action='/wifi'    method='get'><button>Kết nối wifi</button></form><br/>\n", // MENU_WIFI
...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>Tên wifi</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>Mật khẩu</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'><input type='checkbox' id='showpass' onclick='f()'> <label for='showpass'>Hiển thị mật khẩu</label><br/>";
const char HTTP_FORM_WIFI_END[]    PROGMEM = "";
const char HTTP_FORM_STATIC_HEAD[] PROGMEM = "<hr><br/>";
const char HTTP_FORM_END[]         PROGMEM = "<br/><br/><button type='submit'>Lưu lại</button></form>";
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Đã lưu thông tin<br/>Đang cố gắng kết nối với wifi.<br />Nếu không kết nối được truy cập AP để thử lại</div>";
...
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>Không thể kết nối</strong> với {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
...
const char HTTP_STATUS_NONE[]      PROGMEM = "<div class='msg'>Không có thông báo</div>";
...
const char HTTP_HELP[]             PROGMEM =
 "<p/>Github <a href='https://github.com/tquangyb11'>https://github.com/tquangyb11</a>.";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif
...
// @todo remove html elements from progmem, repetetive strings
	...
	const char HTTP_INFO_temp[]       PROGMEM = "<dt>Nhiệt độ</dt><dd>{1} C&deg; / {2} F&deg;</dd>";
...
const char HTTP_INFO_idesize[]    PROGMEM = "<dt>Kích thước flash</dt><dd>{1} bytes</dd>";
const char HTTP_INFO_sdkver[]     PROGMEM = "<dt>SDK version</dt><dd>{1}</dd>";
const char HTTP_INFO_cpufreq[]    PROGMEM = "<dt>Tần số CPU</dt><dd>{1}MHz</dd>";
const char HTTP_INFO_apip[]       PROGMEM = "<dt>Địa chỉ IP</dt><dd>{1}</dd>";
const char HTTP_INFO_apssid[]     PROGMEM = "<dt>Access point SSID</dt><dd>{1}</dd>";
const char HTTP_INFO_autoconx[]   PROGMEM = "<dt>Autoconnect</dt><dd>{1}</dd>";


const char S_brand[]              PROGMEM = "TƯỚI TIÊU TỰ ĐỘNG";
...
const char S_exiting[]            PROGMEM = "Đã thoát";
